...
with open("o_firmware/app_O3C.bin", "rb") as file:
...
with open("bin/main.map", "r") as file:
...
with open("o_firmware/decoded.bin", "wb") as file:
    file.write(fw)
...
# Inject custom code
with open("bin/main.bin", "rb") as main:
